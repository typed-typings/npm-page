...
var index: page.Callback = function() {
    // document.querySelector('p')
    // .textContent = 'viewing index';
};
var about: page.Callback = function() {
    // document.querySelector('p')
    // .textContent = 'viewing about';
};
var contact: page.Callback = function(ctx) {
    // document.querySelector('p')
...
var load: page.Callback = function (ctx, next) {
...
var show: page.Callback = function (ctx) {
